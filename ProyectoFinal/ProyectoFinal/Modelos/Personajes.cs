...
namespace ProyectoFinal.Modelos
{
    class Personajes
    {
        ...
        public class Humano : Personajes
        {
            public class Guerrero: Humano
            {
                string Informacion ="";
                //Puntuacion de caracteristicas
                int fuerza = 16;
                ...
                int refejos = 12;
                int voluntad = 12;
                int puntos_de_golpe = 31;
                int ca = 17;
                //armadura
                string armadura = "escamas";
                //Habilidades
                int atletismo = 8;
                int resistencia = 8;
                int sanar = 6;
            ...
            public class Explorador : Humano
            {
                string Informacion = "";
                //Puntuacion de caracteristicas
                int fuerza = 0;
            ...
            public class SeñorDeLaGuerra : Humano
            {
                string Informacion = "";
                //Puntuacion de caracteristicas
                int fuerza = 0;
